...
public class WordListTest {
		...
		Object[][] data = new Object[][] 
										{
											...
											{"the correct number from the word list", "abc",2,4,
												new String[] { "ab", "bc", "abc", "cba" },
												new String[] { "ab", "bc", "ad", "abc", "cba", "asd","asdfjkafs", "aa" } 
											},
											
											{ "the correct number from the word list II", "abc", 2, 2, null,
												new String[] { "cab", "cba", "asd", "asdfjkafs", "aa" } 
											},
											
											{"no permutations, but shorter suggestions","abcd",	0, 2, null,
												new String[] { "cab", "cba", "asd", "axdr",	"asdfjkafs", "aa" } 
											} 
										};
	...
	{
		wl.addAll(Arrays.asList(words));
		assertEquals(message, permutationCount, wl.permutations(tileRack).size());
	}
